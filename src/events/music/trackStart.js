...
module.exports = (client, player, track) => {
    // Check if the user who requested the song is the same as the user interacting with the buttons
    const isSameUser = (interactionUser) => interactionUser.id === track.requester.id;

    // Create the ActionRowBuilder and add buttons with disabled state based on the user
