...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('help')
                .setDescription('Get information about the server category commands')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('channelinfo')
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .setDescription('Get the oldest account creation date in the server')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('roleinfo')
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .setDescription('Get the youngest account creation date in the server')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('userinfo')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('emojis')
                .setDescription('See the server emojis')
        )
    ,
