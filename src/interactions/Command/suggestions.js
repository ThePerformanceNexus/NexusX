    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(option => option.setName('reason').setDescription('Reason for accepting').setRequired(true))
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('deny')
                ...
                .addStringOption(option => option.setName('id').setDescription('Suggestion message ID').setRequired(true))
                .addStringOption(option => option.setName('reason').setDescription('Reason for denying').setRequired(true))
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('send')
