        ...
        .addSubcommandGroup((group) =>
            group
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('alalala')
                        .setDescription('Play the alalala sound')
                )
        )
        ...
        .addSubcommandGroup((group) =>
            group
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('dubidubidu')
                        .setDescription('Play the Chipi Chipi Dubi Dubi Du sound')
                )
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('elevator')
        ...
        .addSubcommandGroup((group) =>
            group
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('amongus')
                        .setDescription('Play the amougus sound'),
                )
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('ohyeahdaddy')
                        .setDescription('Play the Oh Yeah Daddy! sound'),
                )
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('bingchilling')
                        .setDescription('Play the Bing Chilling sound'),
                )
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('nigganaenae')
                        .setDescription('Play the Nigga Nae Nae sound'),
                )
        ),
    /** 
     * @param {Client} client
