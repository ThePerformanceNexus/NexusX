...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/alalalalalalalalallalala.mp3");

    client.succNormal({ text: "Soundboard started! Playing **alalalalala**", type: 'editreply' }, interaction);
};