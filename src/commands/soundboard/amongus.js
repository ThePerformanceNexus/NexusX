...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/amougus-sus-rap.mp3");

    client.succNormal({ text: "Soundboard started! Playing **amoung us rap**", type: 'editreply' }, interaction);
};