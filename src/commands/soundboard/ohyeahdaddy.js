...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/ohyeahdaddy.mp3");

    client.succNormal({ text: "Soundboard started! Playing **Oh Yeah Daddy!**", type: 'editreply' }, interaction);
};