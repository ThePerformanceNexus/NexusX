...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/dubidubidu.mp3");

    client.succNormal({ text: "Soundboard started! Playing **Dubi Dubi Du**", type: 'editreply' }, interaction);
};