...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/nigga-nigga-nae-nae.mp3");

    client.succNormal({ text: "Soundboard started! Playing **Nigga Nae Nae**", type: 'editreply' }, interaction);
};